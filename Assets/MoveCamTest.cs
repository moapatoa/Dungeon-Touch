...
public class CameraMovementTest : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 directionalMovement = new Vector3(moveLeft + moveRight, 0.0f, moveUp + moveDown) * transform.position.y * moveSpeed * Time.deltaTime * Mathf.Sqrt(transform.position.y / 3.0f);
